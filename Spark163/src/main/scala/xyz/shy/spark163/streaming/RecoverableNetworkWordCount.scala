...
object DroppedWordsCounter {
  ...
  @volatile private var instance: Accumulator[Long] = _
...
object RecoverableNetworkWordCount {
  ...
  : StreamingContext = {
    ...
    val lines = kafkaStream.transform { rdd =>
  ...
  def main(args: Array[String]) {
    ...
    val Array(checkpointDirectory, outputPath) = args
